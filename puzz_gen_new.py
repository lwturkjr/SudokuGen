# This file I was experimenting trying to make this process multithreaded to speed up the overall generation of puzzles and pdfs
...
checks = input("Difficulty 1-inf (whole number): ")
